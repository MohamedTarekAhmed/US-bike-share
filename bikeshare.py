...
def get_filters():
    ...
    while True:
       ...
       if city not in ("new york city" , "chicago" , "washington"):
        print("No data founded for this city please try again")
        continue
       else:
        break     
    ...
    while True:
       ...
       if month not in ("all" , "january" , "february" , "march" , "april" , "may" , "june" ):
        print("No data founded for this mounth please try again")
        continue 
       else:
        break 
    ...
    while True:
        day = input("\nWhich day would you like to filter by ? all , Saturday , Sunday , Monday , Tuesday , Wednesday , Thursday ,Friday ? \n")
        day=day.lower()
        if day not in ("all" , "saturday" , "sunday" , "monday" , "tuesday" , "wednesday" , "thursday" ,"friday"):
          print("No data founded for this day please try again")
          continue 
        else:
          break 
...
def station_stats(df):
    ...
    print('\nThe most ftequent combination of start station and end station trip is:', Start_Station, " & ", End_Station)
...
def user_stats(df,city):
    ...
    try:
      ...
      print("\nThe gender types:\nNo data founded for this month.")
    ...
    try:
      ...
      print('\nThe most eecent year is:', Most_Recent_Year)
    except KeyError:
